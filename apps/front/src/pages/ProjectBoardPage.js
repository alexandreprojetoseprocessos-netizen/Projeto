...
export const ProjectBoardPage = () => {
    ...
    return (_jsxs("section", { className: "project-board-page", children: [_jsxs("header", { className: "page-header", children: [_jsxs("div", { children: [_jsx("h1", { children: "Board do Projeto" }), _jsx("p", { children: selectedProject?.projectName ?? selectedProject?.name ?? "Projeto" })] }), projectBoardError && _jsx("p", { className: "error-text", children: projectBoardError })] }), _jsx(KanbanBoard, { columns: projectBoardColumns ?? [], onDragEnd: onMoveProjectTask ?? (() => { }), onCreate: onCreateProjectTask ?? (async () => false), onTaskClick: onReloadProjectBoard
                    ? () => {
