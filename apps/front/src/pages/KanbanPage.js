...
const KanbanPage = () => {
    ...
    return (_jsxs("section", { className: "kanbanPage", children: [_jsxs("header", { className: "page-header", children: [_jsxs("div", { className: "kanbanHeroMain", children: [_jsx("p", { className: "eyebrow", children: "EAP" }), _jsx("h1", { children: "Kanban" }), _jsx("p", { className: "subtext", children: "Visualizacao por status" }), _jsxs("div", { className: "kanbanHeroStats", "aria-label": "Resumo do quadro", children: [_jsxs("span", { className: "kanbanHeroStat", children: [_jsx("strong", { children: totalTasks }), _jsx("small", { children: "Tarefas" })] }), _jsxs("span", { className: "kanbanHeroStat is-progress", children: [_jsx("strong", { children: inProgressCount }), _jsx("small", { children: "Em andamento" })] }), _jsxs("span", { className: "kanbanHeroStat is-delayed", children: [_jsx("strong", { children: delayedCount }), _jsx("small", { children: "Em atraso" })] }), _jsxs("span", { className: "kanbanHeroStat is-done", children: [_jsx("strong", { children: doneCount }), _jsx("small", { children: "Finalizadas" })] })] }), wbsError && _jsx("p", { className: "error-text", children: wbsError })] }), _jsxs("div", { className: "kanbanFilters", children: [_jsx("input", { className: "gp-input", placeholder: "Buscar tarefa", value: filterText, onChange: (e) => setFilterText(e.target.value) }), _jsxs("select", { className: "gp-input", value: filterOwner, onChange: (e) => setFilterOwner(e.target.value), children: [_jsx("option", { value: "ALL", children: "Respons\u00E1vel" }), members?.map((m) => (_jsx("option", { value: m.id, children: m.name ?? m.email ?? "Membro" }, m.id)))] }), _jsxs("select", { className: "gp-input", value: filterPriority, onChange: (e) => setFilterPriority(e.target.value), children: [_jsx("option", { value: "ALL", children: "Prioridade" }), _jsx("option", { value: "CRITICAL", children: "Urgente" }), _jsx("option", { value: "HIGH", children: "Alta" }), _jsx("option", { value: "MEDIUM", children: "M\u00E9dia" }), _jsx("option", { value: "LOW", children: "Baixa" })] }), _jsxs("select", { className: "gp-input", value: filterDue, onChange: (e) => setFilterDue(e.target.value), children: [_jsx("option", { value: "ALL", children: "Datas" }), _jsx("option", { value: "UPCOMING", children: "A vencer" }), _jsx("option", { value: "OVERDUE", children: "Vencidas" })] })] })] }), _jsx(KanbanBoard, { columns: kanbanColumns, onDragEnd: handleDragEnd, onCreate: handleCreate, onTaskClick: (task) => {
