...
const NewProjectModal = ({ isOpen, onClose, children, title = "Novo projeto", subtitle = "Planeje um novo trabalho informando os dados basicos do projeto no portfolio." }) => {
    if (!isOpen)
        return null;
...
export const ProjectsPage = () => {
    const { portfolio, portfolioError, portfolioLoading, projectsError, onExportPortfolio, selectedProjectId, organizations, selectedOrganizationId, onProjectChange, onCreateProject, onUpdateProject, currentOrgRole, projectLimits } = useOutletContext();
