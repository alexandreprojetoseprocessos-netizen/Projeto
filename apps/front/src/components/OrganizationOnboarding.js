...
export const OrganizationSelector = ({ organizations, onSelect, onCreateOrganization, userEmail, organizationLimits, currentOrgRole, onReloadOrganizations }) => {
    ...
    return (_jsxs("div", { className: "org-page", children: [showLimitBanner && (_jsxs("div", { className: "org-limit-banner", children: [_jsx("div", { className: "org-limit-stripe" }), _jsxs("div", { className: "org-limit-content", children: [_jsx("strong", { children: "Voc\u00EA atingiu o limite de organiza\u00E7\u00F5es do seu plano." }), _jsxs("span", { children: ["Para criar novas organiza\u00E7\u00F5es, atualize seu plano em", " ", _jsx("button", { type: "button", className: "link-button", onClick: () => navigate("/plano"), children: "Meu plano" }), "."] })] })] })), _jsxs("div", { className: "page-header", children: [_jsx("div", { className: "page-header-kicker", children: "BEM-VINDO(A)" }), _jsx("h1", { className: "page-header-title", children: "Criar nova organiza\u00E7\u00E3o" }), _jsx("p", { className: "page-header-subtitle", children: "A organiza\u00E7\u00E3o representa sua empresa, cl\u00EDnica ou neg\u00F3cio. \u00C9 aqui que voc\u00EA concentra projetos, pessoas e documentos." })] }), _jsxs("div", { className: "org-grid", children: [_jsxs("div", { className: "org-left-column", children: [_jsxs("section", { id: "org-create-section", className: "form-card org-form-card", children: [_jsx("h3", { children: "Nova organiza\u00E7\u00E3o" }), _jsxs("form", { className: "org-form", onSubmit: handleSubmit, ref: formRef, children: [_jsx("div", { className: "form-group", children: _jsxs("label", { children: ["Nome da organiza\u00E7\u00E3o", _jsx("input", { type: "text", placeholder: "Ex.: Minha empresa LTDA", value: newOrgName, onChange: (e) => setNewOrgName(e.target.value), required: true })] }) }), _jsx("div", { className: "form-group", children: _jsxs("label", { children: ["Dominio (opcional)", _jsx("input", { type: "text", placeholder: "ex: minhaempresa.com", value: newOrgDomain, onChange: (e) => setNewOrgDomain(e.target.value) })] }) }), _jsx("span", { title: limitReachedTitle, children: _jsx("button", { type: "submit", className: "primary-button org-create-button", disabled: isCreateDisabled, "aria-disabled": isCreateDisabled, children: creating ? "Criando..." : "Criar nova organização" }) })] })] }), _jsxs("div", { className: "org-status-row", children: [_jsxs("button", { type: "button", className: "org-status-box", onClick: () => setShowDeactivatedModal(true), children: [_jsx(PauseCircle, { className: "status-icon status-icon--paused" }), _jsx("span", { children: "Desativados" })] }), _jsxs("button", { type: "button", className: "org-status-box", onClick: () => setShowTrashModal(true), children: [_jsx(Trash2, { className: "status-icon status-icon--trash" }), _jsx("span", { children: "Lixeira (90 dias)" })] })] })] }), _jsxs("div", { className: "plan-card org-plan-card", children: [_jsxs("div", { children: [_jsx("span", { className: "plan-badge", children: "Plano atual" }), _jsx("div", { className: "plan-title", children: planName })] }), _jsx("h3", { children: "Detalhes do plano" }), userEmail && (_jsxs("div", { className: "email-box", children: [_jsx("div", { className: "org-responsible-label", children: "Respons\u00E1vel pelas organiza\u00E7\u00F5es" }), _jsx("div", { className: "org-responsible-email", children: userEmail })] })), _jsxs("div", { className: "org-plan-body", children: [_jsx("p", { className: "org-plan-label", children: "Organiza\u00E7\u00F5es inclu\u00EDdas" }), _jsx("p", { className: "org-plan-value", children: totalSlotsLabel }), _jsx("div", { className: "org-plan-progress", children: _jsx("div", { className: "org-plan-progress-fill", style: { width: `${organizationsPercent}%` } }) }), _jsx("p", { className: "org-plan-helper", children: "Use esta conta para centralizar suas empresas, cl\u00EDnicas ou unidades." })] }), _jsx("button", { type: "button", className: "button-primary org-plan-button", onClick: () => navigate("/plano"), children: "Ver detalhes do plano" })] })] }), _jsxs("section", { className: "org-list-section", children: [_jsx("h2", { className: "org-section-title", children: "Suas organiza\u00E7\u00F5es" }), _jsx("p", { className: "org-section-subtitle", children: "Escolha onde voc\u00EA quer trabalhar hoje." }), orgList.length === 0 ? (_jsxs("div", { className: "org-empty", children: [_jsx("h3", { children: "Nenhuma organiza\u00E7\u00E3o cadastrada ainda" }), _jsx("p", { children: "Crie a sua primeira organiza\u00E7\u00E3o para come\u00E7ar a estruturar seus projetos. Voc\u00EA pode adicionar quantas precisar dentro do seu plano." }), _jsx("button", { type: "button", className: "primary-button", onClick: scrollToCreate, children: "Criar primeira organiza\u00E7\u00E3o" })] })) : (_jsx("div", { className: "org-list-grid", children: orgList.map((organization) => {
                        ...
                        }) }))] }), _jsx(OrgStatusModal, { type: "DEACTIVATED", open: showDeactivatedModal, onClose: () => setShowDeactivatedModal(false), onReload: onReloadOrganizations, limitMax: organizationLimits?.max ?? null }), _jsx(OrgStatusModal, { type: "SOFT_DELETED", open: showTrashModal, onClose: () => setShowTrashModal(false), onReload: onReloadOrganizations, limitMax: organizationLimits?.max ?? null })] }));
};
