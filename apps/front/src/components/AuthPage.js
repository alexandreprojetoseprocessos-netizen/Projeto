...
export const AuthPage = ({ onSubmit, onSignUp, error }) => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            setSubmitting(false);
            setLocalError(submitError instanceof Error
                ? submitError.message
