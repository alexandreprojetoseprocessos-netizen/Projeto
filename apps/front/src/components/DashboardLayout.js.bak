...
export const WbsTreeView = ({ nodes, loading, error, onCreate, onUpdate, onDelete, onRestore, onMove, selectedNodeId, onSelect, dependencyOptions, onUpdateDependency, onOpenDetails }) => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("div", { className: "wbs-table-card", "data-has-selection": selectedTaskIds.length > 0, children: _jsx("div", { className: "edt-horizontal-scroll", children: _jsxs("table", { className: "wbs-table", children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { className: "col-select", children: _jsx("input", { type: "checkbox", "aria-label": "Selecionar todas as tarefas", ref: selectAllRef, checked: isAllVisibleSelected, onChange: (event) => handleSelectAllVisible(event.target.checked) }) }), _jsx("th", { className: "col-id", children: "ID" }), _jsx("th", { className: "col-chat", title: "Coment\u00E1rios da tarefa", children: "Chat" }), _jsx("th", { className: "col-level", children: "N\u00EDvel" }), _jsx("th", { className: "col-name", children: "Nome da tarefa" }), _jsx("th", { className: "col-status", children: "Situa\u00E7\u00E3o" }), _jsx("th", { className: "col-duration", children: "Dura\u00E7\u00E3o" }), _jsx("th", { className: "col-date", children: "In\u00EDcio" }), _jsx("th", { className: "col-date", children: "T\u00E9rmino" }), _jsx("th", { className: "col-owner", children: "Respons\u00E1vel" }), _jsx("th", { className: "col-dependencies", children: "Depend\u00EAncias" }), _jsx("th", { className: "col-actions", children: "Detalhes" }), _jsx("th", {})] }) }), _jsx("tbody", { children: visibleRows.map((row) => {
                                    ...
                                    const ownerTooltip = ownerName && ownerEmail ? `${ownerName} (${ownerEmail})` : ownerName ?? "Sem Responsável definido";
                                    ...
                                    return (_jsx(Fragment, { children: _jsxs("tr", { className: `wbs-row level-${limitedLevel} ${isActive ? "is-active" : ""}`, "data-progress": progressValue, "data-node-id": row.node.id, children: [_jsx("td", { className: "wbs-select-cell", children: _jsx("input", { type: "checkbox", "aria-label": `Selecionar tarefa ${displayId}`, checked: selectedTaskIds.includes(row.node.id), onChange: (event) => {
                                                            event.stopPropagation();
                                                            handleSelectRow(event.target.checked, row.node.id);
                                                        }, onClick: (event) => event.stopPropagation() }) }), _jsx("td", { className: "wbs-id", children: displayId }), _jsx("td", { className: "wbs-chat-cell", children: _jsxs("button", { type: "button", className: "wbs-chat-button", "aria-label": `Comentários da tarefa ${displayId}`, onClick: (event) => {
                                                            event.stopPropagation();
                                                            setOpenChatTaskId(row.node.id);
                                                        }, children: [_jsx(ChatIcon, {}), _jsx("span", { className: "wbs-chat-count", children: Array.isArray(row.node.comments) && row.node.comments.length
                                                                    ? row.node.comments.length
                                                                    : chatCounts[row.node.id] ?? 0 }), (chatCounts[row.node.id] ?? row.node.comments?.length ?? 0) > 0 && (_jsx("span", { className: "wbs-chat-unread" }))] }) }), _jsx("td", { className: "wbs-level-cell", children: _jsxs("div", { className: "wbs-level-actions", role: "group", "aria-label": "Ajustar N\u00EDvel", children: [_jsx("button", { type: "button", className: "level-arrow", "aria-label": "Subir N\u00EDvel", onClick: (event) => handleLevelAdjust(event, row.node.id, "up"), disabled: !canLevelUp, children: "<" }), _jsx("span", { className: `wbs-level-pill ${isRootLevel ? "is-root" : ""}`, children: formattedLevel }), _jsx("button", { type: "button", className: "level-arrow", "aria-label": "Descer N\u00EDvel", onClick: (event) => handleLevelAdjust(event, row.node.id, "down"), disabled: !canLevelDown, children: ">" })] }) }), _jsx("td", { className: "wbs-name-cell", children: _jsxs("div", { className: `wbs-task-name ${visualLevel <= 1 ? "is-phase" : ""} ${levelClass}`, children: [row.hasChildren ? (_jsx("button", { type: "button", className: `wbs-toggle ${isExpanded ? "is-open" : ""}`, onClick: (event) => handleToggle(event, row.node.id, visualLevel), "aria-label": isExpanded ? "Recolher subtarefas" : "Expandir subtarefas", "aria-expanded": isExpanded, children: isExpanded ? "v" : ">" })) : (_jsx("span", { className: "wbs-toggle placeholder" })), _jsx("span", { className: `wbs-node-icon ${row.hasChildren ? "is-folder" : "is-task"}`, children: row.hasChildren ? _jsx(FolderIcon, {}) : _jsx(TaskIcon, {}) }), _jsx("div", { className: "wbs-task-text", title: row.node.title ?? "Tarefa sem nome", onDoubleClick: (event) => handleBeginTitleEdit(event, row.node), children: isEditingTitle ? (_jsx("input", { className: "wbs-title-input", value: editingTitle, onChange: (event) => setEditingTitle(event.target.value), onBlur: commitTitleEdit, onKeyDown: handleTitleKeyDown, onClick: (event) => event.stopPropagation(), autoFocus: true, placeholder: "Nome da tarefa" })) : (_jsxs(_Fragment, { children: [isRootLevel ? (_jsx("strong", { children: row.node.title ?? "Tarefa sem nome" })) : (_jsx("span", { className: "wbs-task-title", children: row.node.title ?? "Tarefa sem nome" })), row.node.description && _jsx("small", { title: row.node.description, children: row.node.description })] })) })] }) }), _jsx("td", { children: _jsxs("div", { style: { position: "relative", display: "inline-flex" }, children: [_jsx("button", { type: "button", className: `wbs-status wbs-status--${status.tone}`, onClick: (event) => handleStatusToggle(event, row.node.id), children: status.label }), isStatusPickerOpen && (_jsx("div", { className: "wbs-status-picker", style: statusPopoverStyle, children: editableStatusValues.map((value) => {
                                                                ...
                                                                }) }))] }) }), _jsx("td", { className: "wbs-Duration-cell", children: _jsxs("div", { className: "wbs-Duration-wrapper", children: [_jsx("input", { type: "number", min: 1, className: "wbs-Duration-input", "aria-label": "Dura\u00E7\u00E3o em dias", value: getDurationInputValue(row.node), placeholder: "\u00E2\u00E2\u00E2\u20AC\u0161\u00C2\u00AC\u00E2\u00E2\u201A\u00AC\u00C2\u009D", onChange: (event) => handleDurationInputChange(row.node.id, event.target.value) }), _jsx("span", { className: "wbs-Duration-suffix", children: Number(getDurationInputValue(row.node) || 0) === 1 ? "dia" : "dias" })] }) }), _jsx("td", { children: _jsxs("div", { className: "wbs-date-input-wrapper", children: [_jsx(CalendarIcon, {}), _jsx("input", { type: "date", "aria-label": "Data de In\u00EDcio", value: formatDateInputValue(row.node.startDate), onChange: (event) => handleDateFieldChange(row.node.id, "startDate", event.target.value) })] }) }), _jsx("td", { children: _jsxs("div", { className: "wbs-date-input-wrapper", children: [_jsx(CalendarIcon, {}), _jsx("input", { type: "date", "aria-label": "Data de T\u00E9rmino", value: formatDateInputValue(row.node.endDate), onChange: (event) => handleDateFieldChange(row.node.id, "endDate", event.target.value) })] }) }), _jsx("td", { children: ownerName ? (_jsxs("div", { className: "wbs-owner", title: ownerTooltip, children: [_jsx("span", { className: "wbs-owner__avatar", children: initials }), _jsx("strong", { children: ownerName })] })) : (_jsx("span", { className: "muted", children: "Sem Respons\u00E1vel" })) }), _jsxs("td", { className: "wbs-dependencies-cell", children: [_jsx("div", { className: `wbs-dependencies-display ${editingDependenciesId === row.node.id ? "is-open" : ""}`, role: "button", tabIndex: 0, onClick: (event) => {
                                                                event.stopPropagation();
                                                                openDependencyEditorForNode(row.node.id, dependencyBadges);
                                                                                    ...
                                                                                    .join("\n"), children: ["+", dependencyInfos.length - 3] }))] })] })) : (_jsx("span", { className: "wbs-dependency-pill muted", children: "Sem Depend\u00EAncias" })) }), editingDependenciesId === row.node.id && (_jsxs("div", { className: "wbs-dependencies-editor", ref: (element) => {
...
export const ProjectDetailsTabs = ({ projectMeta, projectLoading, onEditProject, onAddTask, summary, summaryError, filters, onRangeChange, myTasks, members, membersError, attachments, attachmentsError, attachmentsLoading, reportMetrics, reportMetricsError, reportMetricsLoading, boardColumns, kanbanColumns, boardError, onCreateTask, onReloadBoard, onDragTask, newTaskTitle, onTaskTitleChange, newTaskColumn, onTaskColumnChange, newTaskStartDate, onTaskStartDateChange, newTaskEndDate, onTaskEndDateChange, newTaskAssignee, onTaskAssigneeChange, newTaskEstimateHours, onTaskEstimateHoursChange, wbsNodes, wbsError, onMoveNode, onUpdateNode, selectedNodeId, onSelectNode, comments, commentsError, onSubmitComment, commentBody, onCommentBodyChange, timeEntryDate, timeEntryHours, timeEntryDescription, timeEntryError, onTimeEntryDateChange, onTimeEntryHoursChange, onTimeEntryDescriptionChange, onLogTime, ganttTasks, ganttMilestones, ganttError, onKanbanTaskClick }) => {
    ...
    const overviewHeader = (_jsxs(_Fragment, { children: [_jsxs("div", { className: "project-details__header", children: [_jsxs("div", { children: [_jsx("p", { className: "eyebrow", children: "Detalhes do projeto" }), _jsx("h2", { children: projectMeta.projectName }), _jsxs("p", { className: "subtext", children: ["C\u00F3digo ", projectMeta.code ?? "N/A", " \u2022 Cliente ", projectMeta.clientName ?? "Não informado"] }), _jsxs("div", { className: "project-header__meta", children: [renderStatusBadge(projectMeta.status), _jsxs("span", { children: ["Respons\u00E1vel: ", projectMeta.responsibleName ?? "âââ€šÂ¬ââ‚¬Â"] }), _jsxs("span", { children: ["Per\u00EDodo: ", formatShortDate(projectMeta.startDate), " \u00E2\u00E2\u00E2\u20AC\u0161\u00C2\u00AC\u00E2\u00E2\u201A\u00AC\u00C2\u009D ", formatShortDate(projectMeta.endDate)] })] })] }), _jsxs("div", { className: "project-header__actions", children: [_jsx("button", { type: "button", className: "secondary-button project-action project-action--secondary", onClick: onEditProject, disabled: !onEditProject, children: "Editar projeto" }), _jsx("button", { type: "button", className: "primary-button project-action project-action--primary", onClick: onAddTask, children: "Adicionar tarefa" }), _jsx("button", { type: "button", className: "ghost-button project-action project-action--link", children: "Compartilhar" })] })] }), _jsx("div", { className: "tabs", children: tabs.map((tab) => (_jsx("button", { type: "button", className: activeTab === tab.id ? "is-active" : "", onClick: () => {
                        if (tab.id === "edt") {
