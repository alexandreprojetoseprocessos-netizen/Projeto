...
export const ProjectDetailsTabs = ({ projectMeta, projectLoading, onEditProject, onAddTask, summary, summaryError, filters, onRangeChange, myTasks, members, membersError, attachments, attachmentsError, attachmentsLoading, reportMetrics, reportMetricsError, reportMetricsLoading, boardColumns, kanbanColumns, boardError, onCreateTask, onReloadBoard, onDragTask, newTaskTitle, onTaskTitleChange, newTaskColumn, onTaskColumnChange, newTaskStartDate, onTaskStartDateChange, newTaskEndDate, onTaskEndDateChange, newTaskAssignee, onTaskAssigneeChange, newTaskEstimateHours, onTaskEstimateHoursChange, wbsNodes, wbsError, serviceCatalog, serviceCatalogError, onImportServiceCatalog, onCreateServiceCatalog, onUpdateServiceCatalog, onDeleteServiceCatalog, onReloadWbs, onMoveNode, onUpdateNode, selectedNodeId, onSelectNode, comments, commentsError, onSubmitComment, commentBody, onCommentBodyChange, timeEntryDate, timeEntryHours, timeEntryDescription, timeEntryError, onTimeEntryDateChange, onTimeEntryHoursChange, onTimeEntryDescriptionChange, onLogTime, ganttTasks, ganttMilestones, ganttError, onKanbanTaskClick }) => {
    ...
    if (!projectMeta) {
        return (_jsx("section", { className: "project-details", children: _jsxs("article", { className: "card", children: [_jsx("h2", { children: projectLoading ? "Carregando dados do projeto..." : "Selecione um projeto" }), _jsx("p", { className: "muted", children: projectLoading ? "Buscando cards do portfÂ³lio para montar o cabeÂ§alho." : "Escolha um projeto no topo para ver os detalhes completos." })] }) }));
    }
    const overviewHeader = (_jsxs(_Fragment, { children: [_jsxs("div", { className: "project-details__header", children: [_jsxs("div", { children: [_jsx("p", { className: "eyebrow", children: "Detalhes do projeto" }), _jsx("h2", { children: projectMeta.projectName }), _jsxs("p", { className: "subtext", children: ["C\u00F3digo ", projectMeta.code ?? "N/A", " \u00C3\u00A2\u00C2\u00A2 Cliente ", projectMeta.clientName ?? "Não informado"] }), _jsxs("div", { className: "project-header__meta", children: [renderStatusBadge(projectMeta.status), _jsxs("span", { children: ["Respons\u00E1vel: ", projectMeta.responsibleName ?? "Não informado"] }), _jsxs("span", { children: ["Per\u00C2\u00ADodo: ", formatShortDate(projectMeta.startDate), " \u00C2\u00A2\u00C2\u00A2\u00C2\u00A2\u00C3\u00A2\u00C2\u00AC\u00C2\u00A1\u00C2\u00AC\u00C2\u00A2\u00C2\u00A2\u00C3\u00A2\u00C5\u00A1\u00C2\u00AC\u00C2\u009D ", formatShortDate(projectMeta.endDate)] })] })] }), _jsxs("div", { className: "project-header__actions", children: [_jsx("button", { type: "button", className: "secondary-button project-action project-action--secondary", onClick: onEditProject, disabled: !onEditProject, children: "Editar projeto" }), _jsx("button", { type: "button", className: "primary-button project-action project-action--primary", onClick: onAddTask, children: "Adicionar tarefa" }), _jsx("button", { type: "button", className: "ghost-button project-action project-action--link", children: "Compartilhar" })] })] }), _jsx("div", { className: "tabs", children: tabs.map((tab) => (_jsx("button", { type: "button", className: activeTab === tab.id ? "is-active" : "", onClick: () => {
                        if (tab.id === "edt") {
    ...
    const docsContent = (_jsxs("div", { className: "tab-panel", children: [attachmentsError && _jsx("p", { className: "error-text", children: attachmentsError }), attachmentsLoading ? (_jsx("div", { className: "docs-grid", children: [0, 1, 2].map((index) => (_jsxs("article", { className: "doc-card skeleton-card", children: [_jsx("div", { className: "skeleton skeleton-title" }), _jsx("div", { className: "skeleton skeleton-text" }), _jsx("div", { className: "skeleton skeleton-text", style: { width: "40%" } })] }, index))) })) : attachments.length ? (_jsx("div", { className: "docs-grid", children: attachments.map((doc) => (_jsxs("article", { className: "doc-card", children: [_jsxs("div", { children: [_jsx("h4", { children: doc.fileName }), _jsx("p", { className: "subtext", children: doc.category ?? "Documento" })] }), _jsxs("small", { children: [doc.uploadedBy?.fullName ?? doc.uploadedBy?.email ?? "Equipe", " \u00C2\u00B7 ", formatShortDate(doc.createdAt)] }), _jsxs("small", { children: [formatFileSize(doc.fileSize), " \u00C2\u00B7 ", doc.targetType === "WBS_NODE" ? "Vinculado Â  WBS" : "Projeto"] }), _jsx("button", { type: "button", className: "ghost-button", onClick: () => window.alert("IntegrAo de download em breve."), children: "Baixar" })] }, doc.id))) })) : (_jsx(EmptyStateCard, { icon: FileIcon, title: "Nenhum documento enviado", description: "Centralize atas, contratos e anexos importantes para facilitar o acompanhamento.", actionLabel: "Adicionar documento", onAction: handleAddDocument }))] }));
    const activityContent = (_jsxs("div", { className: "tab-panel activity-panel", children: [_jsxs("article", { className: "card", children: [_jsx("div", { className: "card-header", children: _jsx("h3", { children: "Timeline de atividades" }) }), commentsError && _jsx("p", { className: "error-text", children: commentsError }), activityItems.length ? (_jsx("ul", { className: "activity-timeline", children: activityItems.map((activity) => (_jsxs("li", { children: [_jsx("div", { className: "activity-avatar", children: activity.author?.slice(0, 2).toUpperCase() }), _jsxs("div", { children: [_jsx("strong", { children: activity.author }), _jsx("span", { children: activity.role }), _jsx("p", { children: activity.body }), _jsx("small", { children: formatShortDate(activity.createdAt) })] })] }, activity.id))) })) : (_jsx(EmptyStateCard, { icon: CommentIcon, title: "Nenhuma atividade registrada", description: "Compartilhe atualiza\u00C2\u00A7\u00C2\u00B5es ou registre horas para construir o hist\u00C2\u00B3rico colaborativo do projeto.", actionLabel: "Registrar atualizAo", onAction: focusCommentComposer }))] }), _jsxs("div", { className: "split-grid", children: [_jsxs("article", { className: "card", children: [_jsx("div", { className: "card-header", children: _jsx("h3", { children: "Novo comentrio" }) }), _jsxs("form", { onSubmit: onSubmitComment, className: "feedback-form", children: [_jsx("p", { className: "muted", children: "Selecione um item na EDT para vincular o comentrio." }), _jsx("textarea", { ref: commentTextareaRef, placeholder: "Anote atualiza\u00C2\u00A7\u00C2\u00B5es ou decis\u00C2\u00B5es...", value: commentBody, onChange: (event) => onCommentBodyChange(event.target.value) }), _jsx("button", { type: "submit", className: "primary-button", disabled: !selectedNodeId || !commentBody.trim(), children: "Registrar comentrio" })] })] }), _jsxs("article", { className: "card", children: [_jsx("div", { className: "card-header", children: _jsx("h3", { children: "Registro r\u00C2\u00A1pido de horas" }) }), _jsxs("form", { onSubmit: onLogTime, className: "time-form", children: [_jsx("p", { className: "muted", children: "Selecione uma tarefa na EDT antes de registrar." }), _jsxs("label", { children: ["Data", _jsx("input", { type: "date", value: timeEntryDate, onChange: (event) => onTimeEntryDateChange(event.target.value) })] }), _jsxs("label", { children: ["Horas", _jsx("input", { type: "number", min: "0.25", step: "0.25", value: timeEntryHours, onChange: (event) => onTimeEntryHoursChange(event.target.value) })] }), _jsxs("label", { children: ["descri\u00C2\u00A7\u00C2\u00A3o", _jsx("textarea", { value: timeEntryDescription, onChange: (event) => onTimeEntryDescriptionChange(event.target.value) })] }), timeEntryError && (_jsx("p", { className: "error-text", role: "status", children: timeEntryError })), _jsx("button", { type: "submit", className: "primary-button", disabled: !selectedNodeId, children: "Registrar horas" })] })] })] })] }));
    const boardTabPlaceholder = (_jsx("div", { className: "tab-panel", children: _jsx("p", { className: "muted", children: "O board deste projeto est\u00C2\u00A1 em uma p\u00C2\u00A1gina dedicada." }) }));
    const ganttTabPlaceholder = (_jsx("div", { className: "tab-panel", children: _jsx("p", { className: "muted", children: "O cronograma deste projeto est\u00C2\u00A1 em uma p\u00C2\u00A1gina dedicada." }) }));
    const docsTabPlaceholder = (_jsx("div", { className: "tab-panel", children: _jsx("p", { className: "muted", children: "Os documentos deste projeto est\u00C2\u00A3o em uma p\u00C2\u00A1gina dedicada." }) }));
    const tabContentMap = {
...
const SettingsPanel = () => {
    ...
    return (_jsxs("section", { className: "settings-section", children: [_jsx("header", { children: _jsxs("div", { children: [_jsx("p", { className: "eyebrow", children: "Configura\u00C2\u00A7\u00C2\u00B5es" }), _jsx("h2", { children: "Central de ajustes" }), _jsx("p", { className: "subtext", children: "Gerencie perfil, notificA\u00C2\u00A7\u00C2\u00B5es, Organiza\u00E7\u00E3o e integrA\u00C2\u00A7\u00C2\u00B5es." })] }) }), _jsxs("div", { className: "settings-layout", children: [_jsx("nav", { className: "settings-menu", children: sections.map((section) => (_jsx("button", { type: "button", className: activeSection === section.id ? "is-active" : "", onClick: () => setActiveSection(section.id), children: section.label }, section.id))) }), _jsxs("div", { className: "settings-content", children: [activeSection === "profile" && (_jsxs("form", { className: "settings-form", children: [_jsx("h3", { children: "Perfil" }), _jsxs("label", { children: ["Nome completo", _jsx("input", { type: "text", placeholder: "Seu nome" })] }), _jsxs("label", { children: ["E-mail", _jsx("input", { type: "email", placeholder: "voce@empresa.com" })] }), _jsxs("label", { children: ["Idioma", _jsxs("select", { children: [_jsx("option", { children: "Portugu\u00C2\u00AAs (Brasil)" }), _jsx("option", { children: "Ingl\u00C2\u00AAs" })] })] }), _jsx("button", { type: "button", className: "primary-button", children: "Atualizar perfil" })] })), activeSection === "notifications" && (_jsxs("div", { className: "settings-form", children: [_jsx("h3", { children: "Notifica\u00C2\u00A7\u00C2\u00B5es" }), _jsxs("label", { className: "settings-toggle", children: [_jsx("input", { type: "checkbox", defaultChecked: true }), _jsx("span", { children: "E-mails sobre tarefas atribu\u00C2\u00ADdas" })] }), _jsxs("label", { className: "settings-toggle", children: [_jsx("input", { type: "checkbox" }), _jsx("span", { children: "Mensagens em canais do Slack" })] }), _jsxs("label", { className: "settings-toggle", children: [_jsx("input", { type: "checkbox", defaultChecked: true }), _jsx("span", { children: "Alertas de riscos" })] })] })), activeSection === "organization" && (_jsxs("div", { className: "settings-form", children: [_jsx("h3", { children: "Organiza\u00E7\u00E3o" }), _jsxs("label", { children: ["Nome da Organiza\u00E7\u00E3o", _jsx("input", { type: "text", placeholder: "Organiza\u00E7\u00E3o Demo" })] }), _jsxs("label", { children: ["Dom\u00C2\u00ADnio", _jsx("input", { type: "text", placeholder: "demo.local" })] }), _jsx("button", { type: "button", className: "secondary-button", children: "Salvar" })] })), activeSection === "permissions" && (_jsxs("div", { className: "settings-form", children: [_jsx("h3", { children: "Permiss\u00C2\u00B5es e pap\u00C2\u00A9is" }), _jsx("p", { className: "muted", children: "Gerencie quem pode criar projetos, alterar WBS e exportar dados." }), _jsxs("table", { className: "settings-table", children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { children: "Papel" }), _jsx("th", { children: "Criar projeto" }), _jsx("th", { children: "Editar WBS" }), _jsx("th", { children: "Ver Relat\u00C2\u00B3rios" })] }) }), _jsx("tbody", { children: ["OWNER", "ADMIN", "MEMBER", "VIEWER"].map((role) => (_jsxs("tr", { children: [_jsx("td", { children: role }), _jsx("td", { children: _jsx("input", { type: "checkbox", defaultChecked: role !== "VIEWER" }) }), _jsx("td", { children: _jsx("input", { type: "checkbox", defaultChecked: role === "OWNER" || role === "ADMIN" }) }), _jsx("td", { children: _jsx("input", { type: "checkbox", defaultChecked: role !== "VIEWER" }) })] }, role))) })] })] })), activeSection === "integrations" && (_jsxs("div", { className: "settings-form", children: [_jsx("h3", { children: "Integra\u00C2\u00A7\u00C2\u00B5es" }), _jsx("div", { className: "integrations-grid", children: ["GitHub", "Google Drive", "Slack", "Google Calendar"].map((integration) => (_jsxs("article", { children: [_jsx("strong", { children: integration }), _jsx("p", { className: "muted", children: "Sincronize dados e automatize o fluxo." }), _jsx("button", { type: "button", className: "secondary-button", children: "Conectar" })] }, integration))) })] })), activeSection === "billing" && (_jsxs("div", { className: "settings-form", children: [_jsx("h3", { children: "Faturamento / Plano" }), _jsxs("p", { className: "muted", children: ["Plano atual: ", _jsx("strong", { children: "Pro \u00C2\u00A2\u00C2\u00A2\u00C2\u00A2\u00C3\u00A2\u00C2\u00AC\u00C2\u00A1\u00C2\u00AC\u00C2\u00A2\u00C2\u00A2\u00C3\u00A2\u00C5\u00A1\u00C2\u00AC\u00C3\u00A2 20/50 projetos" })] }), _jsx("button", { type: "button", className: "secondary-button", children: "Gerenciar plano" })] }))] })] })] }));
};
