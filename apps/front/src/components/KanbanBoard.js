...
export const KanbanBoard = ({ columns, onDragEnd, onCreate, onTaskClick, onTaskTitleChange, onTaskColumnChange, newTaskTitle: _newTaskTitle, newTaskColumn: _newTaskColumn, }) => {
    ...
    return (_jsxs("div", { className: "kanbanBoard", children: [_jsx(DragDropContext, { onDragEnd: onDragEnd, children: standardColumns.map((column) => {
                    ...
                    return (_jsxs("div", { className: "kanbanColumn", "data-column-id": column.id, children: [_jsxs("div", { className: "kanbanColumnHeader", children: [_jsxs("div", { className: "kanbanColumnHeaderLeft", children: [_jsx("span", { className: `kanban-status-dot ${STATUS_DOT_CLASS[column.id] ?? ""}` }), _jsx("div", { className: "kanbanColumnTitle", children: column.title }), _jsx("span", { className: "kanbanCountBadge", children: taskCount }), column.wipLimit !== undefined && (_jsxs("span", { className: `kanban-wip-limit ${isOverLimit ? "is-exceeded" : ""}`, children: ["/ ", column.wipLimit] }))] }), _jsx("div", { className: "kanbanColumnActions", children: _jsx("button", { className: "kanbanCreateBtn", type: "button", onClick: () => openCreateModal(column.id), "aria-label": `Criar tarefa em ${column.title}`, title: `Criar tarefa em ${column.title}`, children: "+ Criar" }) })] }), _jsx(Droppable, { droppableId: column.id, children: (provided, snapshot) => (_jsxs("div", { ref: provided.innerRef, ...provided.droppableProps, className: `kanbanColumnBody ${snapshot.isDraggingOver ? "is-dragging-over" : ""}`, children: [taskCount === 0 && (_jsx("div", { className: "kanban-empty-state", children: _jsx("p", { className: "muted", children: "Sem tarefas" }) })), column.tasks.map((task, index) => (_jsx(Draggable, { draggableId: task.id, index: index, children: (dragProvided, dragSnapshot) => {
