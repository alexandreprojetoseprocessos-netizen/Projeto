ï»¿import type { DropResult } from "@hello-pangea/dnd";
...
export const WbsTreeView = ({
  ...
  const resolveStatus = (status?: string | null) => {
    ...
    if (!status) return { label: "Nï¿½o iniciado", tone: "neutral" as StatusTone };
        ...
        <table className="wbs-table">
          ...
          <thead>
            ...
            <tr>
              ...
              <th className="col-level">Nï¿½vel</th>
          ...
          <tbody>
            ...
            {visibleRows.map((row) => {
              ...
              const ownerTooltip =
                ...
                ownerName && ownerEmail ? `${ownerName} (${ownerEmail})` : ownerName ?? "Sem Responsï¿½vel definido";
                ...
                <Fragment key={row.node.id}>
                  ...
                  <tr className={`wbs-row level-${limitedLevel} ${isActive ? "is-active" : ""}`}>
                    ...
                    <td className="wbs-level-cell">
                      ...
                      <div className="wbs-level-actions" role="group" aria-label="Ajustar Nï¿½vel">
                    ...
                    <td>
                      ...
                      {ownerName ? (
                        ...
                        <span className="muted">Sem Responsï¿½vel</span>
                    ...
                    <td className="wbs-dependencies-cell">
                      ...
                      >
                        ...
                        {dependencyInfos.length ? (
                          ...
                          <span className="wbs-dependency-pill muted">Sem Dependï¿½ncias</span>
                      ...
                      <td colSpan={11}>
                        ...
                        <div className="wbs-detail-card">
                          ...
                          <p className="wbs-detail-card__description">
                            ...
                            {selectedNode.description ?? "Nenhuma descriï¿½ï¿½o registrada para esta tarefa."}
                          ...
                          <div className="wbs-detail-card__grid">
                            ...
                            <div>
                              ...
                              <span className="subtext">Inï¿½cio</span>
                            ...
                            <div>
                              ...
                              <span className="subtext">Tï¿½rmino</span>
                            ...
                            <div>
                              ...
                              <span className="subtext">DurAï¿½ï¿½o</span>
                          ...
                          <div className="wbs-detail-card__responsible">
                            ...
                            {selectedNode.owner ? (
                              ...
                              <p className="muted">Defina um Responsï¿½vel para acompanhar esta atividade.</p>
...
export const ProjectDetailsTabs = ({
      ...
      <section className="project-details">
        ...
        <article className="card">
          ...
          <p className="muted">
            ...
            {projectLoading ? "Buscando cards do portfï¿½lio para montar o cabeï¿½alho." : "Escolha um projeto no topo para ver os detalhes completos."}
      ...
      <div className="project-details__header">
        ...
        <div>
          ...
          <p className="subtext">
            ...
            Cï¿½digo {projectMeta.code ?? "â€”"} Â· Cliente {projectMeta.clientName ?? "Nï¿½o informado"}
          ...
          <div className="project-header__meta">
            ...
            <span>Responsï¿½vel: {projectMeta.responsibleName ?? "â€”"}</span>

            <span>

              Perï¿½odo: {formatShortDate(projectMeta.startDate)} â€” {formatShortDate(projectMeta.endDate)}
    ...
    <div className="tab-panel">
        ...
        <article className="card status-card">
          ...
          <ul className="progress-legend">
            ...
            <li>
              ...
              {summary?.totals?.done ?? 0} Concluï¿½das
        ...
        <article className="card">
          ...
          <div className="card-header">
            ...
            <div>
              ...
              <p className="subtext">Visï¿½o dos ï¿½ltimos {filters.rangeDays} dias</p>
      ...
      <div className="overview-grid">
        ...
        <article className="card">
          ...
          <p className="muted">Acompanhe o plano de mitigaï¿½ï¿½o e distribua responsï¿½veis para cada item crï¿½tico.</p>
        ...
        <article className="card">
          ...
          <p className="subtext">Somatï¿½rio das ï¿½ltimas entregas</p>
      ...
      <div className="split-grid">
        ...
        <article className="card">
          ...
          {myTasks.length ? (
            ...
            <p className="muted">Nenhuma tarefa atribuï¿½da.</p>
          ...
          {attachments.map((doc) => (
            <article key={doc.id} className="doc-card">
              ...
              <small>
                ...
                {formatFileSize(doc.fileSize)} Â· {doc.targetType === "WBS_NODE" ? "Vinculado ï¿½ WBS" : "Projeto"}
              ...
              <button
                ...
                onClick={() => window.alert("IntegrAï¿½ï¿½o de download em breve.")}
      ...
      <article className="card">
        ...
        {activityItems.length ? (
          ...
          <EmptyStateCard
            ...
            description="Compartilhe atualizaï¿½ï¿½es ou registre horas para construir o histï¿½rico colaborativo do projeto."
            actionLabel="Registrar atualizAï¿½ï¿½o"
      ...
      <div className="split-grid">
        ...
        <article className="card">
          ...
          <div className="card-header">
            ...
            <h3>Novo comentï¿½rio</h3>

          </div>

          <form onSubmit={onSubmitComment} className="feedback-form">

            <p className="muted">Selecione um item na EDT para vincular o comentï¿½rio.</p>

            <textarea
              ref={commentTextareaRef}
              placeholder="Anote atualizaï¿½ï¿½es ou decisï¿½es..."
              value={commentBody}
              onChange={(event) => onCommentBodyChange(event.target.value)}
            />
            <button type="submit" className="primary-button" disabled={!selectedNodeId || !commentBody.trim()}>

              Registrar comentï¿½rio
        ...
        <article className="card">
          ...
          <div className="card-header">
            ...
            <h3>Registro rï¿½pido de horas</h3>
  ...
  const boardTabPlaceholder = (
    <div className="tab-panel">
      <p className="muted">O board deste projeto estï¿½ em uma pï¿½gina dedicada.</p>
    </div>
  );

  const ganttTabPlaceholder = (
    <div className="tab-panel">
      <p className="muted">O cronograma deste projeto estï¿½ em uma pï¿½gina dedicada.</p>
    </div>
  );

  const docsTabPlaceholder = (
    <div className="tab-panel">
      <p className="muted">Os documentos deste projeto estï¿½o em uma pï¿½gina dedicada.</p>
    </div>
  );
  ...
  const enrichedMembers = useMemo(() => {
    ...
    return members.map((member) => {
      ...
      const status =
        ...
        allocation >= 90 ? "Alta carga" : allocation <= 40 ? "DispoNï¿½vel" : "Balanceado";
    ...
    <section className="team-section">
      ...
      <div className="team-section__header">
        ...
        <div>
          ...
          <h2>Visï¿½o da Equipe do projeto</h2>
      ...
      <div className="team-filters">
        ...
        <label>
          ...
          <select value={statusFilter} onChange={(event) => setStatusFilter(event.target.value)}>
            ...
            <option value="DispoNï¿½vel">DispoNï¿½vel</option>

            <option value="Alocado">Alocado</option>

            <option value="Em fï¿½rias / folga">Em fï¿½rias / folga</option>
          ...
          {filteredMembers.map((member) => (
            ...
            >
              ...
              <div className="team-card__body">
                ...
                <small>AlocAï¿½ï¿½o: {member.allocation}%</small>
    ...
    <section className="reports-section">
      ...
      <header className="reports-header">
        ...
        <div>
          ...
          <p className="eyebrow">Relatï¿½rios</p>

          <h2>Visï¿½o analï¿½tica</h2>

          <p className="subtext">Escolha o foco para comparar resultados do portfï¿½lio.</p>
      ...
      {metricsLoading ? (
        ...
        <p className="muted">Carregando Relatï¿½rios...</p>
            ...
            <article className="reports-card">
              ...
              {hoursByProject.length ? (
                ...
                <EmptyStateCard
                  ...
                  description="Registre horas nos projetos para comparar o esforï¿½o entre Equipes."
                />
              )}
            </article>
          )}
          ...
          {activeTab === "progress" && (
            <article className="reports-card">
              ...
              {progressSeries.length ? (
                ...
                <EmptyStateCard
                  icon={InsightIcon}
                  title="Progresso indispoNï¿½vel"
                  description="Atualize o status das tarefas para gerar a linha de tendï¿½ncia do portfï¿½lio."
                />
              )}
            </article>
          )}
    ...
    <section className="settings-section">
      ...
      <header>
        ...
        <div>
          ...
          <p className="eyebrow">ConfigurAï¿½ï¿½es</p>

          <h2>Central de ajustes</h2>

          <p className="subtext">Gerencie perfil, notificAï¿½ï¿½es, organizAï¿½ï¿½o e integrAï¿½ï¿½es.</p>
        ...
        <div className="settings-content">
            ...
            <form className="settings-form">
              ...
              <label>
                ...
                <select>
                  ...
                  <option>Portuguï¿½s (Brasil)</option>
          ...
          {activeSection === "notifications" && (
            ...
            <div className="settings-form">
              ...
              <h3>NotificAï¿½ï¿½es</h3>

              <label className="settings-toggle">

                <input type="checkbox" defaultChecked />

                <span>E-mails sobre tarefas atribuï¿½das</span>
          ...
          {activeSection === "organization" && (
            ...
            <div className="settings-form">
              ...
              <label>
                ...
                Nome da organizAï¿½ï¿½o

                <input type="text" placeholder="OrganizAï¿½ï¿½o Demo" />
    ...
    <div className={appShellClassName}>
      ...
      <aside className="dashboard-sidebar sidebar">
        ...
        <div className="sidebar-header">
          ...
          <div className="sidebar-logo">
            <span>G&P</span>
            <small>Gestï¿½o de Projetos</small>
          </div>
          <button
        ...
        <nav className="sidebar-nav">
          <div className="sidebar-title">Trabalho diario</div>
      ...
      <div className="dashboard-main">
        ...
        <header className="dashboard-topbar">
          ...
          <div className="gp-container gp-container--compact dashboard-topbar__inner">
            ...
            <div className="modal">
              ...
              <header className="modal-header">
                ...
                <div>
                  ...
                  <h3>{projectModalMode === "edit" ? "Atualize as informAï¿½ï¿½es principais" : "Planeje um novo trabalho"}</h3>
                  ...
                  <p className="subtext">
                    ...
                    {projectModalMode === "edit"
                      ...
                      : "Informe dados bï¿½sicos para criarmos o projeto no portfï¿½lio."}
              ...
              <form className="modal-form" onSubmit={handleProjectModalSubmit}>
                ...
                <label>
                  ...
                  <input
                    ...
                    placeholder="ImplementAï¿½ï¿½o ERP 2025"
                ...
                <label>
                  ...
                  Equipe (e-mails separados por vï¿½rgula)
            ...
            <div className="modal">
              ...
              <header className="modal-header">
                ...
                <div>
                  ...
                  <p className="subtext">Informe o tï¿½tulo e escolha a coluna inicial.</p>
              ...
              {boardColumns.length ? (
                ...
                <div className="modal-form">
                  ...
                  <p className="muted">
                    ...
                    Este projeto ainda Nï¿½o possui colunas configuradas. Configure o quadro para criar tarefas.
