...
export function normalizeStatus(raw) {
    ...
    if (v.includes("atras") || v.includes("delay") || v.includes("late") || v.includes("overdue"))
        return "Em atraso";
    if (v.includes("risco") || v.includes("risk") || v.includes("blocked"))
        return "Em risco";
    return "Não iniciado";
}
export function toBackendStatus(raw) {
    ...
    if (v.includes("backlog") || v.includes("não iniciado") || v.includes("nao iniciado") || v.includes("todo"))
        return "BACKLOG";
    if (v.includes("planej"))
        return "TODO";
    if (v.includes("andam") || v.includes("progress") || v.includes("doing"))
        return "IN_PROGRESS";
    if (v.includes("homolog") || v.includes("revis") || v.includes("review"))
        return "REVIEW";
    if (v.includes("final") || v.includes("done") || v.includes("conclu"))
        return "DONE";
    if (v.includes("atras") || v.includes("delay") || v.includes("late") || v.includes("overdue"))
        return "DELAYED";
    if (v.includes("risco") || v.includes("risk"))
        return "RISK";
